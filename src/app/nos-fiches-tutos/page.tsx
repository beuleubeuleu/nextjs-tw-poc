...
import { getOnePageOfPosts } from "../../_applications/Posts/getOnePageOfPosts";
...
export default async function NosFichesTutos({
  ...
  const { posts, totalPosts, hasPreviousPage, hasNextPage } =
    await getOnePageOfPosts(page);
